...
object Person {
  ...
  def mkRandom: Person = Person(Gen.Aword, Gen.Aword,Gen.Aword,Gen.Aword,Gen.Aword,Gen.Aword,
    ...
    Gen.Aword,Gen.Aword,Gen.Aword,Gen.Aword,Gen.Aword,Gen.Aword,Gen.Aword,Gen.Aword,Gen.Aword,Gen.Aword,Gen.Aword,Gen.Aword,Gen.Aword,Gen.Aword,Gen.Aword,Gen.Aword,Gen.Aword,Gen.Aword,Gen.Aword)
